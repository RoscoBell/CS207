/* The following code was written by José Daniel Herrera Gomariz. It has been adapted by Rosco Bell
    for a class project at the University of Regina, Nov. 2017
*/
/*******************************************************************************************
    ...
    Caleisdoscopio
     ...
     Kaleidoscope based on an Arduino and a strip of addressable rgb LEDs (WS2812, WS2812b or similar).
     Utiliza la librería Neopixel de Adafruit : https://github.com/adafruit/Adafruit_NeoPixel
     Use the Neopixel library of Adafruit: https://github.com/adafruit/Adafruit_NeoPixel
 ********************************************************************************************/
/* Theremin_1
    by Rosco Bell, Oct. 18/17
    from Massimo Banzi
    https://www.youtube.com/watch?v=57S3dylfw3I

    An Optical Theremin - Initial Sketch
*/
...
void loop() {
  ...
  // Adjust the values below to conform to the amximum and minimum
  ...
  /*}
    ...
    void loop() {*/
      int RETARDO = map(sensorValue, sensorHigh, sensorLow, 50, 500);
//    RETARDO = analogRead(A0);
if(RETARDO <50)
{RETARDO = 50;}
else if (RETARDO > 500)
{
...
//Get a color of the whole range from a value from 0 to 255
// the colors are transitions of red -> green -> blue -> red
